    ...
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div className="md:flex md:items-center md:justify-between mb-6">
        ...
        <div className="flex gap-3">
          <Link
            href="/routes/builder"
            className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#00B140] hover:bg-[#009933] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00B140]"
          >
